...
import 'package:pard_app/components/code_snackbar.dart';
import 'package:pard_app/components/pard_appbar.dart';
import 'package:pard_app/components/verification_textfield.dart';
import 'package:pard_app/controllers/phone_verification_controller.dart';
import 'package:pard_app/components/tos_statement.dart';
                          ...
                          onTap: () async {
                            ...
                            if (phoneVerificationController
                              ...
                              phoneVerificationController
                                  ...
                                  .value = await phoneVerificationController
                                  .isVerifyPhoneNumber(
                                    phoneVerificationController
                                        .phoneTextFormField
                                        .value,
                    ...
                    onTap: () async {
                      if (phoneVerificationController.isCorrectCode.value ??
                        ...
                        futureOperations() async {
                          await userController.setUserByEmail(
