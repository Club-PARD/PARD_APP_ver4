...
import 'package:pard_app/components/point_policy_dialog.dart';
...
import 'package:pard_app/models/point_model/point_model.dart';
import 'package:pard_app/models/point_model/point_reason.dart';
import 'package:pard_app/models/point_model/rank_point_model.dart';
import 'package:pard_app/models/user_model/user_model.dart';
...
class _MyPointViewState extends State<MyPointView> {
                ...
                children: [
                  ...
                  Obx(() {
                    ...
                    return Row(
                      ...
                      children: [
                        rankWithTopIcon('top1', context, top3Ranks[0]),
                        rankWithTopIcon('top2', context, top3Ranks[1]),
                        rankWithTopIcon('top3', context, top3Ranks[2]),
                      ],
                    );
                  }),
          ...
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(
                  context,
                ).textTheme.titleSmall!.copyWith(color: grayScale[30]),
              ),
              Text(
                user.name,
                style: Theme.of(
                  context,
                ).textTheme.headlineSmall!.copyWith(color: grayScale[10]),
              ),
            ],
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.titleMedium!.copyWith(color: grayScale[10]),
          ),
          SizedBox(height: 8.h),
          Obx(() {
            return Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.headlineLarge!.copyWith(color: grayScale[10]),
            );
          }),
        ],
      ),
  ...
  Widget myCurrentPoints(context) {
    return Column(
      ...
      children: [
        Text('내 점수 현황', style: Theme.of(context).textTheme.displaySmall),
        SizedBox(height: 16.h),
        Container(
          ...
          child: Padding(
            padding: EdgeInsets.only(left: 54.5.w, right: 54.5.w, top: 24.h),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8.h),
                      Obx(() {
                        if (springUserController.userInfo.value?.totalBonus ==
                            null) {
                          return const CircularProgressIndicator(
                            color: primaryBlue,
                          ); // 로딩 처리
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 8.h),
                      Obx(() {
                        if (springUserController.userInfo.value?.totalMinus ==
                            null) {
                          return const CircularProgressIndicator(
                            color: primaryBlue,
                          ); // 로딩 처리
                        ...
                        return Text(
                          ...
                          style: Theme.of(
                            context,
                          ).textTheme.headlineLarge!.copyWith(color: errorRed),
                        );
                      }),
                    ],
                  ),
  ...
  Widget pointRecordCarouselSlider(context, buttonKey) {
    return Obx(() {
      ...
      List<ReasonBonus> sortedPoints =
          springPointController.pointReasonList.toList();
  ...
  Widget itemInCarouselSlider(
    BuildContext context, {
    bool isFirst = false,
    bool isLast = false,
    required ReasonBonus pointData,
  }) {
