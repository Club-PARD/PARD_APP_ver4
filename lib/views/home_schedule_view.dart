...
import 'package:pard_app/components/pard_part.dart';
...
class HomeSchedule extends StatelessWidget {
  final SpringScheduleController springScheduleController = Get.put(
    SpringScheduleController(),
  );
            ...
            children: [
              ...
              isAllParts
                  ? Column(
                    ...
                    children: [
                      Text(
                        '일시: ${_formatDate(firstSchedule.date)}',
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      Text(
                        '장소: ${firstSchedule.contentsLocation}',
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                    ],
                  )
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        '마감: ${_formatDate(firstSchedule.date)}',
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                    ],
                  ),
