  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: grayScale[30]!, width: 1),
      ),
      child: Padding(
...
class TosDescription extends StatelessWidget {
  ...
  const TosDescription(this.string1, this.string2, this.string3, {super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            string1,
            style: TextStyle(fontSize: 14.sp, color: grayScale[30]),
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
...
class TosCheckbox extends StatelessWidget {
  ...
  const TosCheckbox(this.isAgree, this.height, {super.key});
