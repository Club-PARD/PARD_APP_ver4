  ...
  Future<void> updateTimeByEmail(String email) async {
    ...
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        await userDoc.reference.update({'lastLogin': currentTime});
      } else {
  ...
  Future<bool> hasAlreadyScannedToday(UserModel? user, String? qrCode) async {
    ...
    try {
      ...
      if (latestAttend != null) {
        ...
        DateTime latestAttendDate = DateTime(
          latestAttendDateTime.year,
          latestAttendDateTime.month,
          latestAttendDateTime.day,
        );
